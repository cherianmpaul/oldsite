...
<div id="content" class="bg2">
	<div id="colOne">
      <p align="center"><img border="1" src="images/photo2.jpg" width="175" height="225"></p>
<br>
      <p>Your request has been accepted.</p>
<p> <a href="mailto:<?php echo $_GET["em"] ?>"><?php echo $_GET["em"] ?></a> has been removed from the mailing list</P>
<p> You will not receive any more emails from cherianhosts.com.</p>
